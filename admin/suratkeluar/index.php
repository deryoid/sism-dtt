                                        ...
                                        <table id="example1" class="table table-bordered table-striped">
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td align="center">
                                                        <a href="hapus?id=<?= $row['id_sk'] ?>" class="btn btn-danger btn-sm alert-hapus" title="Hapus"><i class="fa fa-trash"></i></a>
                                                            ...
                                                            <div class="dropdown-menu">
                                                                <a class="dropdown-item" href="status?id=<?= $row['id_sk'] ?>&v=Disetujui">Disetujui</a>
                                                                <a class="dropdown-item" href="status?id=<?= $row['id_sk'] ?>&v=Menunggu">Menunggu</a>
                                                                <a class="dropdown-item" href="status?id=<?= $row['id_sk'] ?>&v=Ditolak">Ditolak</a>
                                                            </div>
                                                        </td>
                                                    </tr>
                                            <?php } ?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Laporan Surat Keluar</h4>
            </div>
            <div class="modal-body">

            <!-- kategori -->
            <label style="font-size: 15px; font-style: bold;">Berdasarkan Kategori</label>
                <form method="POST" target="blank" action="<?= base_url('admin/suratkeluar/print.php') ?>">
                    <div class="row">
                        <div class="col-md-8">
